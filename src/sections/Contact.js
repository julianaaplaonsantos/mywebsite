...
export default function Contact() {
    ...
    return (_jsxs("section", { id: "contact", ref: contactRef, className: `contact-section ${visible ? "visible" : ""}`, children: [_jsx("h2", { className: "contact-title", children: "Let's Connect!" }), _jsxs("div", { className: "contact-buttons", children: [_jsx("a", { href: "https://github.com/julianaaplaonsantos", target: "_blank", rel: "noopener noreferrer", className: "contact-icon-btn", "aria-label": "GitHub", children: _jsx(FaGithub, {}) }), _jsx("a", { href: "https://www.linkedin.com/in/juliana-santos-212a78374/", target: "_blank", rel: "noopener noreferrer", className: "contact-icon-btn", "aria-label": "LinkedIn", children: _jsx(FaLinkedin, {}) }), _jsx("a", { href: "https://www.facebook.com/julianaaplaonsantos/", target: "_blank", rel: "noopener noreferrer", className: "contact-icon-btn", "aria-label": "Facebook", children: _jsx(FaFacebook, {}) }), _jsx("a", { href: "https://wa.me/639630208143", target: "_blank", rel: "noopener noreferrer", className: "contact-icon-btn", "aria-label": "WhatsApp", children: _jsx(FaWhatsapp, {}) })] }), _jsxs("div", { className: "contact-info", children: [_jsxs("p", { children: [_jsx(FaEnvelope, { className: "contact-info-icon" }), _jsx("a", { href: "mailto:japlaonsantos@gmail.com", "aria-label": "Send email to japlaonsantos@gmail.com", className: "contact-link", target: "_blank", rel: "noopener noreferrer", role: "link", children: "japlaonsantos@gmail.com" })] }), _jsxs("p", { children: [_jsx(FaPhone, { className: "contact-info-icon" }), _jsx("a", { href: "tel:+639630208143", "aria-label": "Call 09630208143", className: "contact-link", role: "link", children: "09630208143" })] })] })] }));
}
